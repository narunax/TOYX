...
import DialogueCTA from "@/components/sections/DialogueCTA";
    ...
    <main className="relative overflow-hidden selection:bg-rose-100 selection:text-rose-900">
      ...
      <section className={`relative flex min-h-[90vh] flex-col items-center justify-center ${LAYOUT_PX} text-center`}>
        <div className="flex flex-col items-center gap-6">
          <h1 className="text-8xl font-extralight tracking-[0.25em] text-navy-900 animate-in fade-in slide-in-from-bottom-8 duration-1000 font-serif">
            TOYX
          </h1>
          ...
          <p className="mt-16 max-w-lg text-xl font-extralight text-slate-700 leading-[2] animate-in fade-in slide-in-from-bottom-8 delay-500 duration-1000 font-serif">
            問いかけることで、本質が見える。<br />
            <span className="text-[10px] tracking-[0.4em] text-slate-400 uppercase mt-4 block font-serif italic">Vision Through Questioning</span>
          </p>
        </div>
