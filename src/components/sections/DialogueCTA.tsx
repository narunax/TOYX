...
export default function DialogueCTA() {
    return (
        <section className={`py-32 ${LAYOUT_PX} relative overflow-hidden bg-navy-900`}>
            ...
            <div className="relative mx-auto max-w-5xl text-center">
                <FadeIn>
                    <h2 className="text-4xl md:text-6xl font-extralight text-white mb-8 leading-tight font-serif">
                        問いが、明日を創る。<br />
                        <span className="text-2xl md:text-3xl text-white/50 block mt-4 font-extralight italic font-serif">Question creates the future.</span>
                    </h2>
                </FadeIn>

                <FadeIn delay={0.2}>
                    <p className="text-lg md:text-xl font-light text-white/70 mb-16 max-w-2xl mx-auto leading-relaxed font-serif">
                        解のない時代に、共に不確実性に潜る。<br />
                        プロセスの中にこそ、本質的な価値が宿る。
                    </p>
                </FadeIn>
